...
BLOG_AUTHOR = "Simon van der Veldt"
BLOG_TITLE = "Simon van der Veldt"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://simonvanderveldt.nl/"
...
POSTS = (
    ("_posts/*.md", "", "post.tmpl"),
    ("_drafts/*.md", "", "post.tmpl"),
)
PAGES = (
    ("_pages/*.md", "", "post.tmpl"),
    ("_pages/*.html", "", "post.tmpl"),
)
...
MARKDOWN_EXTENSIONS = ['nl2br', 'fenced_code', 'smart_strong', 'codehilite(linenums=table)', 'footnotes']
...
DISABLED_PLUGINS = ["render_galleries", "render_archive", "render_listings", "render_sources"]
